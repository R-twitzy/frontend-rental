...
export default function Mobil() {
    ...
    let hapusMobil = item => {
        if (window.confirm(`Data mobil yang telah dihapus tidak dapat dikembalikan`)) {
    ...
    return (
        <div className="container-fluid">
            ...
            <div className="row justify-content-center">
                <div className="row justify-content-center" style={{ backgroundImage: `url(${background})`, width: '100%' }}>
                            ...
                            <div className="carousel-inner">
                                ...
                                {mobil.map(item => (
                                    <div className="carousel-item"
                                        ...
                                        <img src={`http://localhost:8080/image/${item.image}`} className="d-block w-100" alt="..." />
                                        <div class="text-center d-none d-md-block text-dark my-3">
                                            <h5><strong>{item.merk}</strong> ({item.jenis})</h5>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        {mobil.map(item => (
                            <li className="list-group-item"
                                ...
                                <div className="row">
                                    {/** Section gambar */}
                                    <div className="col-3">
                                        <img src={`http://localhost:8080/image/${item.image}`} alt=""
                                            style={{ width: `100%` }} />
                                    </div>
                                    {/** section desc 1 */}
                                    <div className="col-2 pt-4">
                                        <h5><strong>{item.merk}</strong></h5>
                                    ...
                                    <div className="col-5 py-5 pe-5 row justify-content-end">
                                        <button className="col-6 btn btn-sm btn-outline-primary my-1 ms-2"
                                            onClick={() => editMobil(item)}>
                                            Edit
                                        </button>
                                        <button className="col-6 btn btn-sm btn-danger my-1 ms-2"
